...
// -------------------------------------------------------------
// GET /  — List all portfolios (any authenticated user)
// POST / — Create a new portfolio entry (manager or above)
// -------------------------------------------------------------
router.route('/')
...
// -------------------------------------------------------------
// Image routes
// POST   /:id/images          — Upload work images (max 20)
// DELETE /:id/images/:imageId — Remove a single image
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// Document routes (PDFs)
// POST   /:id/documents          — Upload PDF documents (max 10)
// DELETE /:id/documents/:docId   — Remove a single document
// -------------------------------------------------------------
